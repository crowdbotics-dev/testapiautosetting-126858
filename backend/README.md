...
## Project Structure
    ...
    ├── testapiautosetting_126858  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126858`
...
2. Clone this repo and `cd testapiautosetting_126858`
